...
# Parameters settings
# Data loading params
tf.flags.DEFINE_string("database_path", "kaggle_news_uci/", "Path for the dataset to be used.")
...
for train_batch in train_batches:
	...
	if current_step % FLAGS.evaluate_every == 0:
		...
		#### ERROR
		'''
		ResourceExhaustedError (see above for traceback): OOM when allocating tensor with shape[64,131,512] and type float on /job:localhost/replica:0/task:0/device:CPU:0 by allocator cpu
         [[Node: conv_block_512_2/conv1d_1/batch_normalization/batchnorm/mul_1 = Mul[T=DT_FLOAT, _device="/job:localhost/replica:0/task:0/device:CPU:0"](conv_block_512_2/conv1d_1/conv1d/Squeeze, conv_block_512_2/conv1d_1/batch_normalization/batchnorm/mul)]]
